...
export default props => {
    ...
    const { finworkbenchs,  addFinWorkBench,  deleteFinWorkBench, updateFinWorkBench } = useContext(FinWorkBenchContext)
    const { loans, updateLoan, addLoan, deleteLoan } = useContext(LoanContext)
...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    return (
        ...
        <>
            <section className="finworkbenchs">
                ...
                <section className="loan__section">
                    ...
                    {/* <div className="loan__cashPaid">${finworkbenchs.cashpaid}</div> */}
                    ...
                    {/* <div className="loan__loanAmount">${finworkbenchs.loanAmount}</div> */}
                    {/* schoolTotalCost - (Cash paid + grantsOther) = loanAmount */}

                    {/* <div className="loan__loanAmount">${finworkbenchs.cashPaid}</div>
                            <div className="loan__loanAmount">${finworkbenchs.grantsAndOther}</div> */}
                    ...
                    {/* <div className="loan__yearsToRepay">{finworkbenchs.loanLengthMonths} Months</div> */}

                    {/* <div className="loan__loanRate">{finworkbenchs.loanRate}%</div> */}

                    {/* <input type="text" className="loan__totalInerest" name="totalinterest" size="8" >
                    </input> */}

                    {/* <div className="loan__totalLoanPmts">${finworkbenchs.loanPmt}</div> */}
                    ...
                    <div className="BCA_buttons">
                        ...
                        <div>
                        <button className="deletefinworkbenchsItem__button"
